...
// export const nonEmpty = value => value === '' ? 'The value must not be empty' : undefined;
export const fiveCharacters = value => value.length === 5 ? undefined : 'The value must be 5 characters long';
export const numbers = value => Number(value) === NaN ? 'Each character must be a number' : undefined;
